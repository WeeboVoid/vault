...
<body class="bg-gray-100 flex items-center justify-center h-screen">
    @include('sideBar')
    <div class="card">
        <h1 class="card-header"><strong>Change Login Password</strong></h1>
        @if ($errors->any())
            <div class="mb-4">
        ...
        @endif
        <form method="POST" action="{{ route('login.change') }}">
            @csrf
            <div class="mb-5">
                <br>
                <input type="password" name="old_login_password" placeholder="Enter Your Old Login Password." class="form-control">
            </div>
            <div class="mb-5">
                <br>
                <input type="password" name="new_login_password" placeholder="Enter Your New login Password" class="form-control">
            </div>
            <div class="mb-5">
                <br>
                <input type="password" name="re_enter_login_password" placeholder="Re-Enter Your New Login Password" class="form-control">
            </div>
            <div class="mb-5">
                <button type="submit" class="btn-primary">Change Login Password</button>
            </div>
        </form>
    </div>
